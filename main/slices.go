...
// Slices are a key data type in Go, giving a more powerful interface to sequences than arrays. Slices are not fixed in size.
func main() {
	...
	// Slices support a “slice” operator with the syntax slice[low:high]. For example, this gets a slice of the elements
	// s[2], s[3], and s[4].
	l := s[2:5]
	fmt.Println("sl1:", l)
	...
	// Slices can be composed into multi-dimensional data structures. The length of the inner slices can vary, unlike
