...
func main() {
	// First we’ll look at basic rate limiting. Suppose we want to limit our handling of incoming requests. We’ll serve
	// these requests off a channel of the same name.
	...
	// We can accomplish this by buffering our limiter channel. This burstyLimiter channel will allow bursts of up to 3
	// events.
